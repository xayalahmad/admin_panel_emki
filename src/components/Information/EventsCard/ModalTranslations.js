...
export default function ModalTranslations({information, setEventContainer}) {
  ...
  return (
    <div>
      ...
      >
        <Box sx={style}>
          <TabsLanguage setEventContainer={setEventContainer} setOpen={setOpen} information={information} getlang={getlang} setGetLang={setGetLang}/>
        </Box>
      </Modal>
    </div>
  );
